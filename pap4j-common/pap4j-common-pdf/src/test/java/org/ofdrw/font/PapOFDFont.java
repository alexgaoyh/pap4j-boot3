...
public class PapOFDFont extends Font {
    ...
    // 2. 补齐必要的构造方法
    public PapOFDFont(String name, String familyName, Path fontFile) {
        // super(...) 内部会触发被重写的 setFontFile()
        super(name, familyName, fontFile);
    }

    public PapOFDFont(String name, Path fontFile) {
        super(name, fontFile);
    }

    public PapOFDFont(String name, String familyName, Path fontFile, double[] printableAsciiWidthMap) {
