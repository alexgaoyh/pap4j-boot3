...
/**
 * <p><strong>Event8PapObserver</strong> 处理 <code>event8</code> 通知。</p>
 *
 * <p>这是 {@link PapObserver} 的一个具体实现。</p>
 */
public class Event8PapObserver implements PapObserver {

    private static final Logger log = LoggerFactory.getLogger(Event8PapObserver.class);

    /**
     * <p>返回事件名称。</p>
     *
     * @return <strong>"event8"</strong>
     */
    @Override
