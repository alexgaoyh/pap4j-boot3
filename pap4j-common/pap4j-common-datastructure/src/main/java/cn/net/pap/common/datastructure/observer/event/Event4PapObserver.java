...
/**
 * <p><strong>Event4PapObserver</strong> 处理 <code>event4</code> 通知。</p>
 *
 * <p>这是 {@link PapObserver} 的一个具体实现。</p>
 */
public class Event4PapObserver implements PapObserver {

    private static final Logger log = LoggerFactory.getLogger(Event4PapObserver.class);

    /**
     * <p>返回事件名称。</p>
     *
     * @return <strong>"event4"</strong>
     */
    @Override
