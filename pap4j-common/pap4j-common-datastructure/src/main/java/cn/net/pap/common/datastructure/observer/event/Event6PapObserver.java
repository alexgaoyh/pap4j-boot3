...
/**
 * <p><strong>Event6PapObserver</strong> 处理 <code>event6</code> 通知。</p>
 *
 * <p>这是 {@link PapObserver} 的一个具体实现。</p>
 */
public class Event6PapObserver implements PapObserver {

    private static final Logger log = LoggerFactory.getLogger(Event6PapObserver.class);

    /**
     * <p>返回事件名称。</p>
     *
     * @return <strong>"event6"</strong>
     */
    @Override
