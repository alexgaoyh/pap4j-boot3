...
public class LogbackInitializer implements ApplicationListener<ApplicationReadyEvent> {
     ...
     * 初始化Logback配置
     */
    public static void initLogbackConfiguration() {
        // todo 这里根据实际情况进行调整，仿照如下调用，可以做到将不同包下的日志写到一起.
//        LogbackConfigurationUtil.initSharedLogConfiguration(Arrays.asList("cn.net.pap", "org.apache"), "pap-apache", Level.INFO);
    }
}