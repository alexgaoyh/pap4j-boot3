        ...
        try (SqlSession session = sqlSessionFactory.openSession(false);
            ...
            try (Statement stmt = conn.createStatement()) {
                ...
                try {
                    ...
                    log.error("transactionalTest rollback failed", e1);
                }
            }
        } catch (Exception e) {
            log.error("transactionalTest", e);
        ...
        try (SqlSession session = sqlSessionFactory.openSession();
            ...
            try (Statement stmt = conn.createStatement()) {
                ...
                try {
                    ...
                    log.error("partFieldUpdateTest rollback failed", e1);
                }
            }
        } catch (Exception e) {
            log.error("partFieldUpdateTest", e);
        ...
        try (SqlSession session = sqlSessionFactory.openSession();
            ...
            try (Statement stmt = conn.createStatement()) {
                ...
                try {
                    ...
                    log.error("updateTestThrowExceptionInMysqlDB rollback failed", e1);
                }
            }
        } catch (Exception e) {
            log.error("updateTestThrowExceptionInMysqlDB", e);
